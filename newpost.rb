...
OptionParser.new do |opts|
  ...
  opts.on('-t', '--title "Title"', 'Post Title. Note: Due to a bug, there must be a space in the title.') { |v| options[:post_title] = v }
...
#todo: If _posts doesn't exist, just write here (cannot think of a use-case where _posts should be created by this tool)
